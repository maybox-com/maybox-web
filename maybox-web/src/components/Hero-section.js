    ...
    <>
      <div className="container mx-auto px-4 md:px-[12em] my-[8em] section-main">
        <section className="flex flex-col  md:flex-row font-neueEinstellung font-regular gap-[6em]">
          ...
          <h1 className="font-meduim font-playtip text-customOrangeDark mb-8 text-2xl md: text-[48px] space-x-3 ">Your Perfect Picks.</h1>
            Products curated just for you. Choose your favorites or let us <br className="block" /> guide
