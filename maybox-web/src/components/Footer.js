...
function Footer() {
  return (
    <>
<footer class="bg-white sm:px-12">
  <div class="mx-auto max-w-screen-xl space-y-8 px-6 py-16 sm:px-12 lg:space-y-16 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="text-customOrangeDark font-playtip text-3xl">
         <span>MAYBOX™</span>
        </div>

        <p class="mt-4 max-w-xs text-gray-500 font-neueEinstellung">
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          <p class="font-medium text-customOrangeDark font-playtip">Services</p>
        ...
        <div>
          <p class="font-medium text-customOrangeDark font-playtip">Helpful Links</p>
        ...
        <div>
          <p class="font-medium text-customOrangeDark font-playtip">Legal</p>
    ...
    <p class="text-xs text-gray-500 font-neueEinstellung">&copy; 2024. Maybox™. All rights reserved.</p>
  </div>
</footer>
    </>
  );
