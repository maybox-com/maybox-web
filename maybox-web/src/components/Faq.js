          ...
          <div className="w-full lg:w-1/2">
            <div className="lg:max-w-xl">
              <div className="mb-6 lg:mb-16">
                <h6 className="text-lg text-center font-medium text-customRed font-ordinary text-3xl mb-2 lg:text-left">Have more questions?</h6>
                <h2 className="text-2xl text-center font-normal font-neueEinstellung leading-[3.25rem] mb-5 lg:text-left">
                  Looking for answers?
                </h2>
              </div>
              <div className="accordion-group font-neueEinstellung font-thin" data-accordion="default-accordion">
                <Accordion
